...
<div class="container">
	<a class="navbar-brand" href="#">SEH Task Scheduler</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item <?php if($currentPage == "team" || $currentPage == "team_edit") { echo "active";}?>"><a class="nav-link" href="team.php">Team</a></li>
